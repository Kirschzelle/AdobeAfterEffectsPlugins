	...
	PF_LayerDef		*output )
{
	...
	PF_ADD_CHECKBOX(STR(StrID_ZETA_Param_Name), STR(StrID_ZETA_Param_Name), true, 0, ZETA_DISK_ID);
	...
	PF_ADD_CHECKBOX(STR(StrID_WILD_Param_Name), STR(StrID_WILD_Param_Name), false, 0, WILD_DISK_ID);
	...
	const char* inHostVersion)
{
	...
	result = PF_REGISTER_EFFECT_EXT2(
		...
		"Kuwahara", // Name
		"dvuYtho Kuwahara", // Match Name
		"dvuYtho Plugins", // Category
		AE_RESERVED_INFO, // Reserved Info
		"EffectMain",	// Entry point
		"https://www.youtube.com/@dvuytho");	// support URL
